...
### See the latest live content via the continuous integration build of the [Australian Digital Health Agency FHIR Implementation Guide](https://build.fhir.org/ig/AuDigitalHealth/mhr-fhir/).
...
1. Open the following link in a browser: https://build.fhir.org/ig/AuDigitalHealth/mhr-fhir/
...
As a first step you should search the [open issues](https://github.com/AuDigitalHealth/mhr-fhir/issues?q=is%3Aopen) and [closed issues](https://github.com/AuDigitalHealth/mhr-fhir/issues?q=is%3Aclosed) to see if the issue has already been reported (it may also be fixed).
